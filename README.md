...
<p align="center">
  <img src="https://latex.codecogs.com/svg.image?\begin{aligned}t_i &\sim \mathrm{N}(\mu_{\text{age}(i)} + \alpha_{\text{teammate(i)}}, \sigma_{\text{age}(i)}), \\\mu_{\text{age}(i)} &\sim \mathrm{N}(0,1) \\ \sigma_{\text{age}(i)} &\sim \mathrm{N}(0,1), \\\alpha_{\text{teammate}(i)} &\sim \mathrm{N}(0, 0.5).\end{aligned}"/>
</p>
